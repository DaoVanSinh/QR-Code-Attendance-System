...
public class SessionService {
        ...
        public List<CourseResponse> getMyCourses() {
                ...
                return courseRepository.findByTeacherId(teacher.getId()).stream()
                                .map(course -> {
                                        com.qrcode.backend.entity.Schedule secondary = scheduleRepository
                                        ...
                                        return CourseResponse.builder()
                                                        ...
                                                        .startLesson2(secondary != null ? secondary.getStartPeriod()
                                                                        : null)
        ...
        public SessionResponse createSession(Integer courseId, CreateSessionRequest request) {
                ...
                auditService.logAction(teacher, "SESSION_CREATED",
                                "Teacher created session " + session.getId() + " for course " + courseId);
        ...
        public List<AttendanceRecordResponse> getSessionAttendances(Integer sessionId) {
                ...
                return records.stream()
                                .map(att -> AttendanceRecordResponse.builder()
                                                ...
                                                .studentName(att.getStudent().getProfile() != null
                                                                ? att.getStudent().getProfile().getFullName()
                                                                : "No Profile")
        ...
        public List<ManualAttendanceStudentResponse> getEnrolledStudentsWithStatus(Integer courseId,
                        Integer sessionId) {
                CustomUserDetails userDetails = (CustomUserDetails) SecurityContextHolder.getContext()
                                .getAuthentication().getPrincipal();
                User teacher = userDetails.getUser();
                ...
                return enrollments.stream().map(enrollment -> {
                        ...
                        return ManualAttendanceStudentResponse.builder()
                                        ...
                                        .studentName(student.getProfile() != null ? student.getProfile().getFullName()
                                                        : student.getEmail())
        ...
        public void manualCheckIn(Integer sessionId, List<Integer> studentIds) {
                ...
                auditService.logAction(teacher, "MANUAL_CHECK_IN", "Teacher manually checked in " + studentIds.size()
                                + " students for session " + sessionId);
        }
         ...
         * Giảng viên chỉ có thể xuất báo cáo của buổi học thuộc học phần mình phụ
         * trách.
         *
        ...
        public ByteArrayInputStream exportSessionAttendanceReport(Integer sessionId) throws IOException {
                ...
                AttendanceCourseInfo courseInfo = AttendanceCourseInfo.builder()
                                .subjectName(course.getSubject().getName())
                                .courseCode(course.getCourseCode() != null ? course.getCourseCode() : course.getClasses().getName())
